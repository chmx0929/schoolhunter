...
<div class="container">
	...
	<tbody>
		<?php
	$query=mysql_query("select * Review")or die(mysql_error());
	while($row=mysql_fetch_array($query)){
	$id=$row['review_id'];
	?>
		<tr>
			<td><?php echo $row['rtext']; ?></td>
			<td width="50"><?php 
	$comment_query=mysql_query("select * from rtext where post_id='$id'")or die(mysql_error());
